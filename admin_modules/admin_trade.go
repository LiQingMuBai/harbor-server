...
func (m *AdminUserModule) ReviewSpotDelegate(r *gin.Context) {
	...
	m.SendResponse(r, common.HTTP_CODE_SUCCESS, adminmodels.MODEL_TRADE.ReviewSpotDelegate(rq))
}

func (m *AdminUserModule) SpotDelegate(r *gin.Context) {
	rq := make(adminmodels.P, 0)
	m.ConvertObject(r, &rq)
	m.SendResponse(r, common.HTTP_CODE_SUCCESS, adminmodels.MODEL_TRADE.ListDelegates(rq, true, ""))
}

func (m *AdminUserModule) DeleteDelegateHistory(r *gin.Context) {
	id := m.GetInt(r, "id")
	m.SendResponse(r, common.HTTP_CODE_SUCCESS, adminmodels.MODEL_TRADE.DeleteDelegateHistory(id))
}
...
func (m *AdminUserModule) ExecuteManualDelegateTrade(r *gin.Context) {
	uid := m.GetInt(r, "uid")
	sn := m.GetValue(r, "sn")
	m.SendResponse(r, common.HTTP_CODE_SUCCESS, adminmodels.MODEL_TRADE.ExecuteManualDelegateTrade(uid, sn))
}
...
func (m *AdminUserModule) ListOpenTrades(r *gin.Context) {
	...
	m.ConvertObject(r, &rq)
	rq["state"] = 1
	m.SendResponse(r, common.HTTP_CODE_SUCCESS, adminmodels.MODEL_TRADE.ListOpenTrades(rq, true, ""))
}

func (m *AdminUserModule) ListClosedTrades(r *gin.Context) {
	rq := make(adminmodels.P, 0)
	m.ConvertObject(r, &rq)
	m.SendResponse(r, common.HTTP_CODE_SUCCESS, adminmodels.MODEL_TRADE.ListClosedTrades(rq, true, ""))
}

func (m *AdminUserModule) StopMiningOrder(r *gin.Context) {
	id := m.GetInt(r, "id")
	pass := m.GetValue(r, "pass")
	m.SendResponse(r, common.HTTP_CODE_SUCCESS, adminmodels.MODEL_USER.StopMiningOrder(id, pass))
}

func (m *AdminUserModule) ListMiningOrders(r *gin.Context) {
	rq := make(adminmodels.P, 0)
	m.ConvertObject(r, &rq)
	m.SendResponse(r, common.HTTP_CODE_SUCCESS, adminmodels.MODEL_USER.ListMiningOrders(rq))
}

func (m *AdminUserModule) DeleteExplodeTrade(r *gin.Context) {
	m.SendResponse(r, common.HTTP_CODE_SUCCESS, adminmodels.SYSTEM_MODEL.DeleteExplodeTrade(m.GetInt(r, "id")))
}

func (m *AdminUserModule) SaveExplodeTrade(r *gin.Context) {
	rq := make(adminmodels.P, 0)
	m.ConvertObject(r, &rq)
	m.SendResponse(r, common.HTTP_CODE_SUCCESS, adminmodels.SYSTEM_MODEL.SaveExplodeTrade(rq))
}
