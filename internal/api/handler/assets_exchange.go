...
func (m *AssetModule) exchangeRoutes() common.MODULEHANDLELIST {
	return common.MODULEHANDLELIST{
		...
		&common.ModuleHandles{Method: "post", Path: "/assets/quickexchange", Handles: common.HandleArray{m.NeedLogin, m.QuickExchange}},
	}
}
